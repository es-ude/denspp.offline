...
if(changePos)
    ...
    if(length(dataAxis.YAxis) == 2)
        ...
        switch(noAxes(1))
            ...
            case 3
                dataSubPlot(3).Position = [0.13 0.14 0.76 0.24];
                dataSubPlot(2).Position = [0.13 0.62 0.76 0.24];
                dataSubPlot(1).Position = [0.13 0.15 0.76 0.24];
            case 4
        ...
        switch(noAxes(1))
            case 1
                dataSubPlot(1).Position = [0.16 0.2 0.78 0.78];
            case 2
                dataSubPlot(2).Position = [0.14 0.61 0.82 0.36];
                dataSubPlot(1).Position = [0.14 0.14 0.82 0.36];
            case 3
                dataSubPlot(3).Position = [0.13 0.74 0.74 0.24];
                dataSubPlot(2).Position = [0.13 0.42 0.74 0.24];
                dataSubPlot(1).Position = [0.13 0.1  0.74 0.24];                
            case 4

...
def merge_rgc_onoff_fzj(path2folder: str, index_name: str) -> None:
    """"""
    frames_in = list()
    frames_cl = list()
    cluster_dict = list()
    ...
    # --- Getting the data
    folders = glob(join(path2folder, index_name))
...
if __name__ == "__main__":
    ...
    index_name = 'waveforms_*.mat'

    merge_rgc_onoff_fzj(path2folder, index_name)

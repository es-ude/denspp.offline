...
def __dnn_train_classification(config_train: Config_PyTorch, config_data: Config_Dataset, mode_cell_bib=0, only_plot_results=False) -> None:
...
def do_train_dnn(mode_train: int, noise_std_ae=0.05, mode_cell_bib=0, only_plot_results=False) -> None:
    ...
    """
    from settings_ai import config_train, config_data
    match mode_train:
        case 0:
            __dnn_train_autoencoder(config_train, config_data, mode=0, noise_std=noise_std_ae,
                                    mode_cell_bib=mode_cell_bib,
                                    only_plot_results=only_plot_results)
        case 1:
            __dnn_train_autoencoder(config_train, config_data, mode=1, noise_std=noise_std_ae,
                                    mode_cell_bib=mode_cell_bib,
                                    only_plot_results=only_plot_results)
        case 2:
            __dnn_train_autoencoder(config_train, config_data, mode=2, noise_std=noise_std_ae,
                                    mode_cell_bib=mode_cell_bib,
                                    only_plot_results=only_plot_results)
        case 3:
            return NotImplementedError
        case 4:
            __dnn_train_classification(config_train, config_data, mode_cell_bib=mode_cell_bib,
                                       only_plot_results=only_plot_results)
        case 5:
            __dnn_train_spike_detection(config_train, config_data,
                                        only_plot_results=only_plot_results)
        case other:
            print("Wrong model!")

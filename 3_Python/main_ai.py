...
if __name__ == "__main__":
    ...
    (Xin, Yin, Xout, Yout) = aiprocess.prepare_autoencoder_data(TrainDataIn, TrainDataOut, frames_cluster, train_size=0.7, valid_size=0.2)
    ...
    nnTorch.initTrain(
        ...
        valid_size=0.2,
        shuffle=False,
        model_name="denoising_autoencoder_v1"
    )

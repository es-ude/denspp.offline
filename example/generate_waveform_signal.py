...
if __name__ == "__main__":
    ...
    time_duration = [0.25 for idx in range(num_elements)]
    ...
    wfg_generator = WaveformGenerator(100e3)
    ...
    wfg_generator.check_charge_balancing(signal1['y'])
    ...
    plt.figure()
    plt.plot(signal1['t'], signal1['y'], 'k')
    plt.xlabel("Time t / s")
    plt.ylabel("Signal y(t)")
    plt.grid()
    plt.tight_layout()

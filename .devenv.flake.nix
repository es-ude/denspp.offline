{
  ...
  version = "1.11.1";
  system = "x86_64-linux";
  devenv_root = "/mnt/c/Git/denspp.offline";
  project_input_ref = "path:/mnt/c/Git/denspp.offline";
  devenv_dotfile = "/mnt/c/Git/denspp.offline/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-017b602";
  ...
  hostname = "nixos";
  username = "nixos";
  git_root = "/mnt/c/Git/denspp.offline";
  secretspec = null;
};
    in
    {

...
class DatasetLoader(ControllerDataset):
    ...
    def __get_rgc_tdb(self) -> None:
        self.__download_spike('2023-11-24_Dataset_RGC_TDB_ONOFF.npy')

    def __prepare_rgc_tdb(self) -> dict:
        return self.__preprocess_spike()

    def __get_rgc_mcs(self) -> None:
        self.__download_spike('2024-11-25_Dataset_RGC_MCS_ONOFF_FZJ.npy')

    def __prepare_rgc_mcs(self) -> dict:
        return self.__preprocess_spike()

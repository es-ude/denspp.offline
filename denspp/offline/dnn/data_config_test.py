...
from .data_config import SettingsDataset, TransformLabels, logic_combination
...
class TestLabelTransformation(TestCase):
    def test_logic_combination(self):
        ...
        rslt = logic_combination(labels_in=TransformLabels(true=true, pred=pred), translate_list=tran)

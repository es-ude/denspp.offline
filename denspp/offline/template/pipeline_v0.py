...
from denspp.offline.analog.adc import SuccessiveApproximation as ADC0
from denspp.offline.analog.amplifier import PreAmp, SettingsAMP
...
from denspp.offline.postprocessing import calc_spike_ticks
...
class SettingsPipe:
    ...
    def __init__(
        ...
        self.SettingsCL = SettingsCluster(type="kMeans", no_cluster=3)

...
class DataLoader(ControllerData):
    ...
    def __load_martinez_simulation(self) -> None:
        ...
        path2file = self._prepare_access_file(
            folder_name="_SimDaten_Martinez2009", data_type="simulation_*.mat"
        )
    ...
    def __load_pedreira_simulation(self) -> None:
        ...
        path2file = self._prepare_access_file(
            folder_name="_SimDaten_Pedreira2012", data_type="simulation_*.mat"
        )
        path2label = self._prepare_access_file(
            folder_name="_SimDaten_Pedreira2012", data_type="ground_truth.mat"
        )
        loaded_data = loadmat(path2file)

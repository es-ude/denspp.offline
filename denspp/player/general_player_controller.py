...
from .output_devices import hardware_specification_oscilloscope_mox4, hardware_specification_denspp_player, hardware_specification_denspp_player_sdcard
...
class GeneralPlayerController:
    ...
    def _config_hardware_controller(self) -> DataTranslator:
        ...
        elif used_device[0] == "DensPPPlayer":
            specific_device_settings = hardware_specification_denspp_player()
        elif used_device[0] == "DensPPPlayer_SDCard":

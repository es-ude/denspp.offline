...
from denspp.offline.data_process.transformation import do_fft_withimag
from src_impfit.imp_fitting.plot_impfit import plot_transient_stimulation, plot_transient_fft, plot_impedance
...
class ImpFitHandler:
    ...
    def calculate_impedance_from_transient_dict(
        ...
        transient_quant = do_quantize_transient(transient_signal, fs_used, u_lsb)
